...
export default {
  ...
  methods: {
    getDataApiOrderByDate() {
      axios
        .get(
          "https://gateway.marvel.com:443/v1/public/comics?orderBy=focDate&ts=" +
        ...
        .then(response => {
          this.data_order_date = response.data;
          this.order_results = this.data_order_date.data.results;
        })
        .catch(error => {
